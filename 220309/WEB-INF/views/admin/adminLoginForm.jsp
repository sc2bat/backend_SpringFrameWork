...
<script src="resources/admin/script/admin.js"></script>
</head>
<body>
...
<header>
	<div id="logo">
		<a href="admin">
			<img src="resources/admin/images/bar_01.gif" style="float:left;">	
	...
	<form name="frm" method="post" action="adminLogin">
		<table>
			...
			<tr align="center" ><td  colspan="2">	
				<input class="btn" type="submit" value="로그인" onClick="return worker_check();">

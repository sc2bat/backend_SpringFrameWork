...
<form method="post" name="joinForm" action="memberUpdate">
	<fieldset>
		...
		<label>User ID</label><input type="text" name="id" value="${loginUser.userid}" readonly><br>
	...
	<fieldset>
	    ...
	    <label>Address</label><input type="text" name="addr1"   size="50" value="${loginUser.address}"><br>
	    <label>&nbsp;</label>	<input type="text" name="addr2"   size="25" value="${loginUser.address2}"><br>

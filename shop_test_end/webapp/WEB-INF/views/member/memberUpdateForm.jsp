...
<form method="post" name="joinForm" action="memberUpdate">
	...
	<fieldset>
	    ...
	    <label>Zip Code</label><input type="text" name="zip_num" size="10" value="${loginUser.znum}">      
	    	<input type="button" value="주소 찾기" class="dup" onclick="post_zip()"><br>
	    <label>Address</label><input type="text" name="addr1"   size="50" value="${loginUser.addr1}"><br>
	    <label>&nbsp;</label>	<input type="text" name="addr2"   size="25" value="${loginUser.addr2}"><br>

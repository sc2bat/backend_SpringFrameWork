...
<%@ include file="/resources/sub03/sub_img.html" %>
...
<table id="cartList">
    ...
    <c:forEach items="${orderList}"  var="orderVO">
    	<tr ><td><fmt:formatDate value="${orderVO.oIndate}" type="date"/></td>
			...
			<td>
				<c:if test="${orderVO.odResult=='1'}">미처리</c:if>
				<c:if test="${orderVO.odResult=='2'}">완료</c:if>
		</td></tr>
    </c:forEach>  

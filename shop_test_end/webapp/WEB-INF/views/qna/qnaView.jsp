...
<h3> 고객님의 질문에 대해서 운영자가 1:1 답변을 드립니다.</h3>
	...
	<table>
		<tr><th width="100" align="center">제목</th><td>${qnaVO.qSubject}</td></tr>
		<tr><th align="center">등록일</th>
			<td align="left"><fmt:formatDate value="${qnaVO.qIndate}" type="date"/></td></tr>
		<tr><th align="center">질문내용</th><td align="left">${qnaVO.qContent}</td></tr>
